...
public class HibernateTemplate extends HibernateAccessor implements HibernateOperations {
	...
	public List findByValueBean(final String queryString, final Object valueBean)
			throws DataAccessException {
		logger.debug(">>>>>>>>>>>>>>>>>>>>>value bean{}"+valueBean);
	...
	/**
	 * james mo add fix map problem
	 * @param queryString
	 * @param valueBean
	 * @return
	 * @throws DataAccessException
	 */
	public List findByValueBean(final String queryString, final Map valueBean)
	throws DataAccessException {
		logger.debug(">>>>>>>>>>>>>>>>>>>>>map value bean{}"+valueBean);
